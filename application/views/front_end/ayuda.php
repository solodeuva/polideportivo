<section class="contenido">
	...
	<div class="div-usuarios">
		<br>
		<h2 id="inicio-sesion">1.	Inicio de Sesión</h2><br>
		...
		<center><img id="img-1" src="<?php echo base_url(); ?>assets/img/galeria/login.jpg"></center>
		<br>
		...
		<?php if(isset($_SESSION['logged_in'])): #si ha iniciado sesion se mostrara el contenido sino el mensaje de error?>
			...
			<center><img id="img-1" src="<?php echo base_url(); ?>assets/img/galeria/gestionar-usuarios.jpg"></center>
			<br>
			...
			<center><img id="img-1" src="<?php echo base_url(); ?>assets/img/galeria/nuevo-usuario.jpg"></center>
			...
			<center><img id="img-1" src="<?php echo base_url(); ?>assets/img/galeria/ver-usuarios.jpg"></center>
			...
			<center><img id="img-1" src="<?php echo base_url(); ?>assets/img/galeria/editar-usuario.jpg"></center>
			...
			<center><img id="img-1" src="<?php echo base_url(); ?>assets/img/galeria/gestionar-niveles.jpg"></center>
			...
			<center><img id="img-1" src="<?php echo base_url(); ?>assets/img/galeria/crear-nivel.jpg"></center>
			...
			<p>Al ingresar a Ver Niveles, se muestra de la siguiente manera:</p><br>
			<center><img id="img-1" src="<?php echo base_url(); ?>assets/img/galeria/ver-niveles.jpg"></center>
			...
			<center><img id="img-1" src="<?php echo base_url(); ?>assets/img/galeria/editar-nivel.jpg"></center><br>
			...
			<center><img id="img-1" src="<?php echo base_url(); ?>assets/img/galeria/gestionar-alumnos.jpg"></center><br>
			...
			<center><img id="img-1" src="<?php echo base_url(); ?>assets/img/galeria/calendario.jpg"></center>
			<p>En el calendario daremos click en la flechita hacia abajo que esta a la derecha de la fecha (marcada en rojo en la imagen) y nos mostrara la siguiente opción:</p><br>
			<center><img id="img-1" src="<?php echo base_url(); ?>assets/img/galeria/calendario2.jpg"></center>
			...
			<center><img id="img-1" src="<?php echo base_url(); ?>assets/img/galeria/buscar2-alumno.jpg"></center>
			...
			<p>Al escoger una de las cinco formas de búsqueda y ejecutarla, se mostrarán los resultados de la siguiente manera:</p><br>
			<center><img id="img-1" src="<?php echo base_url(); ?>assets/img/galeria/result-busq-alum.jpg"></center>
			...
			<img src="<?php echo base_url(); ?>assets/img/galeria/descripcion-estado.jpg"><br>
			...
			<img id="img-2" src="<?php echo base_url(); ?>assets/img/galeria/descripcion-estado2.jpg" >
			...
			<img id="img-2" src="<?php echo base_url(); ?>assets/img/galeria/estado2.jpg"><br>

			<h4 id="ver-ficha">Ver Ficha</h4>
			<img src="<?php echo base_url(); ?>assets/img/galeria/ficha.jpg">
			<p>Nos lleva a la siguiente vista:</p>
			<center><img id="img-1" src="<?php echo base_url(); ?>assets/img/galeria/ficha2-alumno.jpg"></center>
			...
			<center><img id="img-1" src="<?php echo base_url(); ?>assets/img/galeria/subir-foto.jpg"></center>
			...
			<center><img id="img-1" src="<?php echo base_url(); ?>assets/img/galeria/ficha3-alumno.jpg"></center>
			<br>
			...
			<center><img id="img-1" src="<?php echo base_url(); ?>assets/img/galeria/reportes.jpg"></center>
			<br>
			...
			<center><img id="img-1" src="<?php echo base_url(); ?>assets/img/galeria/g-pastel.jpg"></center>
			...
			<center><img id="img-1" src="<?php echo base_url(); ?>assets/img/galeria/g-barras.jpg"></center>

			<br><br>
			<h2 id="desarrolladores">Desarrolladores</h2>
