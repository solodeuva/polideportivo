<section class="contenido">
	...
	<div class="div-usuarios">
		...
		<p>Para hacer uso del sistema se debe poseer un nombre de usuario y una contraseña asignados por el administrador las cuales debera ingresar en el formulario de inicio de sesión:<p>
		...
		<?php if(isset($_SESSION['logged_in'])): #si ha iniciado sesion se mostrara el contenido sino el mensaje de error?>
			...
			<p>Después de ingresados los datos, para guardarlos, se da click sobre el botón “Registrar Usuario”. El botón “Regresar” cancela esta operación y regresa al menú de “Gestionar Usuario” sin registrar datos.</p>
			...
			<p>Después de realizar los cambios, hacemos click en “Actualizar”, al guardarse los datos exitosamente, nos redirigirá al menú “Gestionar Usuarios”.</p>
			...
			<p>Elimina un usuario de manera permanente, al darle click al botón, nos pedirá confirmación de la acción a la cual podemos aceptar o cancelar.</p>
			<br>
			...
			<img src="<?php echo base_url(); ?>assets/img/galeria/eliminar.jpg">
			<p>Elimina un nivel de manera permanente, al darle click al botón, nos pedirá confirmación de la acción a la cual podemos aceptar o cancelar.</p>
			...
			<p>Al finalizar de ingresar los datos damos click en el botón “Ingresar Alumno” Esto creará un registro en la base de datos. El botón “Regresar” nos lleva nuevamente al menú “Gestionar Alumno” sin registrar datos.</p>
			...
			<p>La primera es directamente desde los resultados de búsqueda dando click en la imagen del estado:</p>
			...
			<p>La segunda manera es cambiarlo desde la opción Editar Alumno donde seleccionamos el estado en el combobox y damos click en Actualizar Alumno.</p>
			...
			<img src="<?php echo base_url(); ?>assets/img/galeria/eliminar.jpg">
			<p>Al dar click sobre la imagen, nos mostrará un cuadro de confirmación, daremos click en “Aceptar” para borrar los datos de manera permanente y regresando al menú “Gestionar Alumno”. Esta acción también elimina la foto asociada al alumno.</p>
			<p></p>
			<br><br>
